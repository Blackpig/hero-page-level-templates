...
class Content_model extends CI_Model
{
	...
	*/
	...
	function new_content ($type, $user, $title = '', $url_path = '', $topics = array(), $privileges = array(), $publish_date = FALSE, $custom_fields = array(), $content_page_template = '') {	
		...
		$insert_fields = array(
							...
							'content_hits' => '0',
							'content_page_template' => (isset($content_page_template)) ? $content_page_template : ''
						);
	...
	function get_contents ($filters = array(), $counting = FALSE) {
		...
		foreach ($result->result_array() as $content) {
			$this_content = array(
								...
								'page_template' => $content['content_page_template'], //Blackpig - page template override
